...
Public Class frmChangePassword
    ...
    Private Sub cmdset_Click(sender As Object, e As EventArgs) Handles cmdset.Click
        ...
        Try
            com.CommandText = "update tblaccounts set password='" & EncryptTripleDES(UCase(globalUsername) + txtVerifypassword.Text) & "' where accountid='" & globaluserid & "'" : com.ExecuteNonQuery()
